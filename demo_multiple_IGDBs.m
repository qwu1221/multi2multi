%% This demo evaluate the performance of Algorithm 1 in a bipartite graph with two IGDBs
...
[s_rev,t_rev, c_rev, lambda_rev]=greedy_lik_fun(W1,c_vec0,lambda_vec0,r);
...
[s_rev2,t_rev2, c_rev2, lambda_rev2]=greedy_lik_fun(W2,c_vec0,lambda_vec0,r);
