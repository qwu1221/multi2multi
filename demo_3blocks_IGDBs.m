%% This demo evaluates the performance of Algorithm 1 in a bipartite graph with three IGDBs
%% Generate a bipartite graph with three IGDBs
k=60;   % case+control
q1=0.8;q2=0.1;
mu0=0;mu1=1;sigma=1;
delta=(mu1-mu0)/sigma*sqrt(k/4);
N = 200; M = 100; n1 = 30; m1 = 20;  n2 = 20; m2=20; n3 = 15; m3=15;
...
s_left = setdiff(1:N,[s_in s_in2 s_in3]);
t_left = setdiff(1:M,[t_in t_in2 t_in3]);
figure;imagesc(W1([s_in s_in2 s_in3 sort(s_left)],[t_in t_in2 t_in3 sort(t_left)]));colormap jet;colorbar;
